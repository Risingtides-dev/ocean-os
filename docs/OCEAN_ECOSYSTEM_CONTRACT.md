...
| `GET` | `/v1/rooms/persistent/{key}/inspect` | Read the Room's access, owner, local execution context, agent bindings, profile references and credential-slot status; resource grants remain unavailable. | Loopback trust only; credential-free read |
