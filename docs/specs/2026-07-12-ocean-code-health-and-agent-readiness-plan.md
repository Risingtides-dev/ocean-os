...
3. Publish the narrowed topic-projection/demo checkpoint, then separately manifest real convene plus title/control governance before calls and any genuinely remaining state registry/control-plane boundary.
