# Archived Longhouse orchestration design

> Historical design snapshot from `docs/LONGHOUSE_ORCHESTRATION.md` on 2026-07-14. It mixes shipped and proposed behavior and is not a current contract. Load only for forensic/design-history work.
