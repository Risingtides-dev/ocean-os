...
- [`specs/2026-07-19-ocean-daemon-longhouse-governance-control-extraction-manifest.md`](specs/2026-07-19-ocean-daemon-longhouse-governance-control-extraction-manifest.md) — active characterization-first checkpoint for claim/revoke/recall/breach/board HTTP control adapters; real convene remains a later security-sensitive manifest.
