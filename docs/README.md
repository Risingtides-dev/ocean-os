...
- [`specs/2026-08-16-ocean-rooms-distributed-workspace-architecture.md`](specs/2026-08-16-ocean-rooms-distributed-workspace-architecture.md) — operator-approved 2026-08-17 concept for Rooms as a distributed authorization and work context: room-scoped agent bindings, member-contributed folders and compute, a logical resource namespace spanning Ocean nodes, Tailscale-backed direct operations, local enforcement, and extension-owned multi-node orchestration. [`Gate 0`](specs/2026-08-17-ocean-rooms-gate0-decisions-and-threat-model.md) is accepted; it authorizes preparation and review of a local-only Phase 1 manifest, not implementation. [`Phase 1 room-agent authorization manifest`](specs/2026-08-25-ocean-rooms-phase1-room-agent-authorization-manifest.md) is **operator-accepted 2026-08-25 for concurrent implementation and review** (independent review has not run): it specifies the daemon-owned room-agent binding, the fail-closed local operator principal, pinned package digests, the capability intersection, and the add/inspect/re-authorize/suspend/revoke surface. It carries implementation authority for Phase 1 only.
- [`specs/2026-09-01-ocean-rooms-definition-of-done.md`](specs/2026-09-01-ocean-rooms-definition-of-done.md) — the production-grade finish line for Ocean Rooms across ocean-os, ocean-surface and ocean-bedrock, written 2026-09-01 from three read-only assessments: every line is something a member can do from a shipped surface, can see, and an executable check pins, with the repo and effort named. It drives the Ocean Loop's priority; it authorizes no implementation by itself.
