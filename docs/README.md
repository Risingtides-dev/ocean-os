...
- [`specs/2026-07-27-ocean-extension-stage-a-implementation-manifest.md`](specs/2026-07-27-ocean-extension-stage-a-implementation-manifest.md) — proposed, awaiting operator ratification; exact Crew Stage A / Extension Phases 2–3 contract for metadata-only lifecycle delivery, supervised services, and local/pinned-Git package management. It authorizes no code before ratification.
