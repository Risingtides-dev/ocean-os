...
- `specs/2026-07-17-ocean-observatory-architecture.md` governs the Ocean Observatory direction; `specs/2026-07-17-observatory-gate0-decisions.md` records operator-accepted Gate 0 decisions and the 90s-game visual-parity ruling. Implementation requires an accepted Gate 1 manifest first; whole-daemon observation requires the authenticated metadata-safe snapshot/replay/live contract before Surface renderer work.
