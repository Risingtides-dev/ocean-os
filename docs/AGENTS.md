...
- `specs/2026-07-17-ocean-observatory-architecture.md` governs the proposed Ocean Observatory direction. It is a Gate 0 decision document, not an implementation work order; whole-daemon observation requires an authenticated metadata-safe snapshot/replay/live contract before Surface renderer work.
