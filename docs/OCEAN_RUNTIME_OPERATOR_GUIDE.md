...
DELETE /v1/extensions/{id}                {expected_state_revision, purge_state:false} — only when every scope is disabled and the service is reaped (else 409 extension_active); revokes install, trust, acknowledgement, bindings, enablement
