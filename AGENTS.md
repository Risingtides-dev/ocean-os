...
- The Ocean Observatory program is governed by `docs/specs/2026-07-17-ocean-observatory-architecture.md` with Gate 0 accepted in `docs/specs/2026-07-17-observatory-gate0-decisions.md` (operator ruling: 90s pixel-game visual parity on truthful real events with a durable event store; security invariants unchanged). Gate 1 implementation manifest: `docs/specs/2026-07-17-observatory-gate1-implementation-manifest.md` (all code task dependencies specified). Gate 1 tasks 2–9 await operator acceptance of the manifest before implementation begins. Do not build from the Claude Design export code or the raw global agent firehose.
