...
- [ ] Implement and independently review the daemon-owned metadata projection, durable ordered replay, authenticated snapshot/live API, and extension admission/binding contract before building the production animated Surface renderer. Implementation (tasks 2–8) is landed and the Task 9 independent review is retained at [`docs/specs/2026-07-20-observatory-gate1-task9-independent-review.md`](docs/specs/2026-07-20-observatory-gate1-task9-independent-review.md); its gating repairs G1–G5 landed as one wave on 2026-09-25 (see the review's "Repair wave" section); the gate opens once that wave's delta review passes.
